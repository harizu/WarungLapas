...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.wargaBinaan.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.warga-binaans.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="nomor_registrasi">{{ trans('cruds.wargaBinaan.fields.nomor_registrasi') }}</label>
                <input class="form-control {{ $errors->has('nomor_registrasi') ? 'is-invalid' : '' }}" type="text" name="nomor_registrasi" id="nomor_registrasi" value="{{ old('nomor_registrasi', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_warga_binaan') ? 'is-invalid' : '' }}" type="text" name="nama_warga_binaan" id="nama_warga_binaan" value="{{ old('nama_warga_binaan', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kasus') ? 'is-invalid' : '' }}" type="text" name="kasus" id="kasus" value="{{ old('kasus', '') }}">
                @if($errors->has('kasus'))
