    ...
    private function postPembelianStep2(array $data)
    {
        ...
        DB::beginTransaction();
            ...
            return redirect()->back()->with(
                ...
                . ' berhasil di buat. Silahkan melakukan pembayaran sebesar '
                . $order->total_pembayaran . ' ke Rekening: '
                . config('transaction.rekening.bank') . ' '
                . config('transaction.rekening.no') . ' a.n '
                . config('transaction.rekening.atas_nama')
            );
        try {
